...
public class EntertainmentAdapter extends BaseAdapter {
   private Context context;
    ...
    private List<EntertainmentModel> list;
    public EntertainmentAdapter(Context context, List<EntertainmentModel> regionModelList){
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            convertView  = mLayoutInflater.inflate( R.layout.entertainment_item,null);
        ...
        if (!TextUtils.isEmpty(list.get(position).getEntertainment_name())){
            holder.name.setText(list.get(position).getEntertainment_name());
        }
