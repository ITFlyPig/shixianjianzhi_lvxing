 ...
 */
package com.SelfTourGuide.singapore.base;
...
public class BaseApplication extends MultiDexApplication {
    ...
    private static final String TAG = com.SelfTourGuide.singapore.base.BaseApplication.class.getSimpleName();

    private static com.SelfTourGuide.singapore.base.BaseApplication INSTANCE;

    public static com.SelfTourGuide.singapore.base.BaseApplication getInstance() {
        return INSTANCE;
    }
    Context context;
    @Override
