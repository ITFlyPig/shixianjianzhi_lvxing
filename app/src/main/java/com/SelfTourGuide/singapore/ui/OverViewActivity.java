...
import com.SelfTourGuide.singapore.assetsdb.OverViewDao;
import com.SelfTourGuide.singapore.base.BaseActivity;
import com.SelfTourGuide.singapore.model.OverviewModel;
import com.SelfTourGuide.singapore.util.Advertisement;
import com.SelfTourGuide.singapore.util.MyScrollView;
...
public class OverViewActivity extends BaseActivity implements View.OnClickListener,MyScrollView.OnHeaderRefreshListener {
   ...
   private void getdata(){
    ...
    private void initData(){
       //初始化db数据管理类
        AssetsDatabaseManager.initManager(com.SelfTourGuide.singapore.ui.OverViewActivity.this);
