...
import com.SelfTourGuide.singapore.adapter.ShoppingAdapter;
...
public class ShoppingActivity extends BaseActivity {
    private static  final String TAG= com.SelfTourGuide.singapore.ui.ShoppingActivity.class.getSimpleName();
    ...
    private void initData(){
        ...
        //初始化db数据管理类
        AssetsDatabaseManager.initManager(com.SelfTourGuide.singapore.ui.ShoppingActivity.this);
        ...
        if(NetUtils.isNetworkConnected(com.SelfTourGuide.singapore.ui.ShoppingActivity.this) || PayStatusUtil.isSubAvailable()){
            if (listdate!=null&&listdate.size()>0){
                adapter = new ShoppingAdapter(this,listdate);
                mUIllempty.setVisibility(View.GONE);
                mUIListView.setVisibility(View.VISIBLE);
        ...
        mUIListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(com.SelfTourGuide.singapore.ui.ShoppingActivity.this,ShoppingInfoActivity.class);
