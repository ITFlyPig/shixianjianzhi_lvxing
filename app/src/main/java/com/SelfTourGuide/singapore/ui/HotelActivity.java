...
import com.SelfTourGuide.singapore.adapter.HotelAdapter;
...
public class HotelActivity extends BaseActivity {
    ...
    private static final String TAG= com.SelfTourGuide.singapore.ui.HotelActivity.class.getSimpleName();
    ...
    private void initData(){
        ...
        //初始化db数据管理类
        AssetsDatabaseManager.initManager(com.SelfTourGuide.singapore.ui.HotelActivity.this);
        ...
        mUIListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(com.SelfTourGuide.singapore.ui.HotelActivity.this,HotelInfoActivity.class);
        ...
        if(NetUtils.isNetworkConnected(com.SelfTourGuide.singapore.ui.HotelActivity.this) || PayStatusUtil.isSubAvailable()){
            if (listdate!=null&&listdate.size()>0){
                adapter = new HotelAdapter(this,listdate);
                mUIllempty.setVisibility(View.GONE);
                mUIListView.setAdapter(adapter);
