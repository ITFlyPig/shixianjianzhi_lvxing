...
import com.SelfTourGuide.singapore.adapter.RestaurantAdapter;
...
public class RestaurantActivity extends BaseActivity {
    ...
    private void initData(){
        ...
        //初始化db数据管理类
        AssetsDatabaseManager.initManager(com.SelfTourGuide.singapore.ui.RestaurantActivity.this);
        ...
        mUIListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(com.SelfTourGuide.singapore.ui.RestaurantActivity.this,RestaurantInfoActivity.class);
        ...
        if(NetUtils.isNetworkConnected(com.SelfTourGuide.singapore.ui.RestaurantActivity.this) || PayStatusUtil.isSubAvailable()){
            if (listdate!=null&&listdate.size()>0){
                adapter = new RestaurantAdapter(this,listdate);
                mUIllempty.setVisibility(View.GONE);
                mUIListView.setAdapter(adapter);
