...
public class DownProApp extends BaseActivity {
    @Bind(R.id.rl_down)
...
//            mUIllempty.setVisibility(View.VISIBLE);
   ...
   public void DownClick(View v){
       try {
           startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.SelfTourGuidePro.bangkok")));
...
//            Toast.makeText(BaseApplication.getInstance(), "DownPro 有效订阅的数量：" + size + ":::" + (subs == null ? 0 :subs.size()), Toast.LENGTH_LONG).show();
    ...
    public void onResume() {
        super.onResume();
        FragmentMainActivity.checkSub();//每做一次购买操作就查询一次
