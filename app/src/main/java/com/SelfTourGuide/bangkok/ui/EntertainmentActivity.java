...
import com.SelfTourGuide.bangkok.adapter.EntertainmentAdapter;
...
public class EntertainmentActivity extends BaseActivity {
    ...
    private final String TAG= com.SelfTourGuide.bangkok.ui.EntertainmentActivity.class.getSimpleName();
    ...
    private void getData() {
        AssetsDatabaseManager.initManager(com.SelfTourGuide.bangkok.ui.EntertainmentActivity.this);
    ...
    private void initData() {
        ...
        if(NetUtils.isNetworkConnected(com.SelfTourGuide.bangkok.ui.EntertainmentActivity.this) || PayStatusUtil.isSubAvailable()) {
            if (listdate != null && listdate.size() > 0) {
                adapter = new EntertainmentAdapter(this, listdate);
                mUIllempty.setVisibility(View.GONE);
                mUIListView.setAdapter(adapter);
...
//                    }
        ...
        mUIListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(com.SelfTourGuide.bangkok.ui.EntertainmentActivity.this,EntertainmentInfoActivity.class);
