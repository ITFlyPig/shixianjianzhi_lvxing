...
public class MainTab03$$ViewBinder<T extends com.SelfTourGuide.singapore.fragment.MainTab03> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131689863, "field 'rl_collection'");
    target.rl_collection = finder.castView(view, 2131689863, "field 'rl_collection'");
    view = finder.findRequiredView(source, 2131689510, "field 'title'");
    target.title = finder.castView(view, 2131689510, "field 'title'");
    view = finder.findRequiredView(source, 2131689864, "field 'image_arrow'");
    target.image_arrow = finder.castView(view, 2131689864, "field 'image_arrow'");
    view = finder.findRequiredView(source, 2131689865, "field 'nodata'");
    target.nodata = finder.castView(view, 2131689865, "field 'nodata'");
